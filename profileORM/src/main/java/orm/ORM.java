...
public class ORM {
    ...
    public static <DbData> List<DbData> getAllData(String dataBase) {
        ...
        try {
            ...
            MyLogger.logger.info("Log: Get all data has been accessed");
            return data;
    ...
    public static Profile getDataById(int id){
        ...
        try {
            ...
            if(rs.next()) {
                MyLogger.logger.info("Log: Resource id: " + id + " was accessed");
    ...
    public static Profile deleteData(int id)throws ResourceNotFoundException {
        ...
        try {
            ...
            if(rs.next()) {
                MyLogger.logger.info("Log: Resource with id: " + id + " was deleted");
                return buildObject(rs);
            } else {
                throw new ResourceNotFoundException("Log: Resource with id: " + id + " was not found in database.");
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public static Profile addData(Profile p){
        ...
        try {
            ...
            if(rs.next()) {
                MyLogger.logger.info("Log: New data has been added.");
                return buildObject(rs);
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public static Profile updateData(Profile change){
        ...
        try {
            ...
            if(rs.next()) {
                MyLogger.logger.info("Log: Data has been updated.");
                return buildObject(rs);
            }
